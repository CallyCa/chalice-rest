...
from chalice_rest.db.dependencies import get_db_session
from chalice_rest.db.utils import create_database, drop_database
from chalice_rest.services.kafka.dependencies import get_kafka_producer
from chalice_rest.services.kafka.lifetime import init_kafka, shutdown_kafka
from chalice_rest.services.rabbit.dependencies import get_rmq_channel_pool
from chalice_rest.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from chalice_rest.services.redis.dependency import get_redis_pool
from chalice_rest.settings import settings
from chalice_rest.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from chalice_rest.db.meta import meta  # noqa: WPS433
    from chalice_rest.db.models import load_all_models  # noqa: WPS433
